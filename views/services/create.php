<!-- Apple-style Service Create Header -->
<div class="container-fluid">
        ...
        <div class="col-12">
            <div class="apple-card">
                <div class="d-flex justify-content-between align-items-center p-4">
                    <div>
                        <h1 class="h2 mb-2 fw-semibold text-dark">Создание услуги</h1>
                        <p class="text-secondary mb-0 fs-6">Добавьте новую услугу в каталог автосервиса</p>
                    </div>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="apple-card">
                <form method="POST" action="index.php?page=services&action=create" class="service-create-form">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control-apple" 
                                              ...
                                              name="description" 
                                              rows="4"
                                              placeholder="Подробное описание услуги..."><?= htmlspecialchars($_POST['description'] ?? '') ?></textarea>
                    ...
                    <div class="form-actions p-4 bg-light border-top">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <button type="submit" class="btn btn-apple px-4">
                                <i class="fas fa-save me-2"></i>Создать услугу
                            </button>
                        </div>
                    </div>
                </form>
...
<style>
/* Service Create Form Specific Styles */
.service-create-form .form-section {
    position: relative;
}

.service-create-form .section-title {
    font-size: 18px;
    font-weight: 600;
...
.service-create-form .form-group {
    margin-bottom: 0;
}

.service-create-form .form-label {
    font-size: 15px;
    font-weight: 500;
    color: var(--apple-black);
    margin-bottom: 8px;
...
/* Service Create Input Groups */
.service-create-form .input-group {
    position: relative;
}

.service-create-form .input-group .form-control-apple {
    border-top-right-radius: 0;
    border-bottom-right-radius: 0;
    border-right: none;
}

.service-create-form .input-group-text {
...
/* Service Create Form Switch */
.service-create-form .form-check.form-switch {
    padding-left: 0;
}

.service-create-form .form-switch .form-check-input {
    width: 48px;
    height: 24px;
    border-radius: 12px;
...
.service-create-form .form-switch .form-check-input:checked {
    background-color: var(--apple-blue);
    border-color: var(--apple-blue);
}

.service-create-form .form-switch .form-check-input:focus {
    box-shadow: 0 0 0 3px rgba(0, 122, 255, 0.1);
}

.service-create-form .form-check-label {
    font-size: 15px;
    font-weight: 500;
    color: var(--apple-black);
    cursor: pointer;
...
/* Service Create Category Selector */
.service-create-form .category-selector .d-flex {
    align-items: stretch;
}

.service-create-form .category-selector select {
    border-top-right-radius: 0;
    border-bottom-right-radius: 0;
    border-right: none;
}

.service-create-form .category-selector button {
...
/* Service Create Form Actions */
.service-create-form .form-actions {
    background: var(--apple-gray);
    border-top: 1px solid var(--apple-gray-2);
}

/* Service Create Clean borders */
.service-create-form .border-bottom {
    border-color: var(--apple-gray-2) !important;
}

.service-create-form .border-top {
    border-color: var(--apple-gray-2) !important;
}

/* Service Create Responsive */
@media (max-width: 768px) {
    .service-create-form .row.g-4 {
        --bs-gutter-x: 1rem;
    }
    ...
    .service-create-form .form-actions .d-flex {
        flex-direction: column;
        gap: 12px;
    }
    
    .service-create-form .form-actions .btn {
        width: 100%;
